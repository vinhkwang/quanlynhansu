...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="count">
                <div class="sidebar-brand-icon rotate-n-15">
                    <i class="fas fa-laugh-wink"></i>
                </div>
                <div class="sidebar-brand-text mx-3">Quản Lý Công Việc</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="count">
                    ...
                    <span><%= role == 1 ? "Admin": role ==2 ? "PM":"Member" %></span></a>
            </li>
